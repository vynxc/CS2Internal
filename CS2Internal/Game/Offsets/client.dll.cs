...
{
    // C_CSWeaponBase
    public const int m_bClientPredictDelete = 0x1A00; // bool
    public const int m_bRedraw = 0x1A01; // bool
    public const int m_bIsHeldByPlayer = 0x1A02; // bool
    public const int m_bPinPulled = 0x1A03; // bool
    public const int m_bJumpThrow = 0x1A04; // bool
    public const int m_eThrowStatus = 0x1A08; // EGrenadeThrowState
    public const int m_fThrowTime = 0x1A0C; // GameTime_t
    public const int m_flThrowStrength = 0x1A10; // float
    public const int m_flThrowStrengthApproach = 0x1A14; // float
    public const int m_fDropTime = 0x1A18; // GameTime_t
    public const int m_nNextHoldTick = 0x1A1C; // GameTick_t
    public const int m_flNextHoldFrac = 0x1A20; // float
}
...
{
    // C_CSWeaponBase
    public const int m_szScreenText = 0x1A00; // char[32]
    public const int m_activeLightParticleIndex = 0x1A20; // ParticleIndex_t
    public const int m_eActiveLightEffect = 0x1A24; // C4LightEffect_t
    public const int m_bStartedArming = 0x1A28; // bool
    public const int m_fArmedTime = 0x1A2C; // GameTime_t
    public const int m_bBombPlacedAnimation = 0x1A30; // bool
    public const int m_bIsPlantingViaUse = 0x1A31; // bool
    public const int m_entitySpottedState = 0x1A38; // EntitySpottedState_t
    public const int m_nSpotRules = 0x1A50; // int32_t
    public const int m_bPlayedArmingBeeps = 0x1A54; // bool[7]
    public const int m_bBombPlanted = 0x1A5B; // bool
    public const int m_bDroppedFromDeath = 0x1A5C; // bool
}
...
{
    // C_CSPlayerPawn
    public const int m_animgraph = 0x23A0; // CUtlString
    public const int m_animgraphCharacterModeString = 0x23A8; // CUtlString
    public const int m_flInitialModelScale = 0x23B0; // float
}
...
public static class C_CSPlayerPawn
{
    ...
    public const int m_bLastHeadBoneTransformIsValid = 0x2368; // bool
    public const int m_lastLandTime = 0x236C; // GameTime_t
    public const int m_bOnGroundLastTick = 0x2370; // bool
    public const int m_qDeathEyeAngles = 0x238C; // QAngle
    public const int m_bSkipOneHeadConstraintUpdate = 0x2398; // bool
}
...
public static class C_CSWeaponBase
{
    ...
    public const int m_thirdPersonSequences = 0x1618; // HSequence[6]
    public const int m_ClientPreviousWeaponState = 0x1648; // CSWeaponState_t
    public const int m_iState = 0x164C; // CSWeaponState_t
    public const int m_flCrosshairDistance = 0x1650; // float
    public const int m_iAmmoLastCheck = 0x1654; // int32_t
    public const int m_iAlpha = 0x1658; // int32_t
    public const int m_iScopeTextureID = 0x165C; // int32_t
    public const int m_iCrosshairTextureID = 0x1660; // int32_t
    public const int m_flGunAccuracyPosition = 0x1664; // float
    public const int m_nViewModelIndex = 0x1668; // uint32_t
    public const int m_bReloadsWithClips = 0x166C; // bool
    public const int m_flTimeWeaponIdle = 0x1670; // GameTime_t
    public const int m_bFireOnEmpty = 0x1674; // bool
    public const int m_OnPlayerPickup = 0x1678; // CEntityIOOutput
    public const int m_weaponMode = 0x16A0; // CSWeaponMode
    public const int m_flTurningInaccuracyDelta = 0x16A4; // float
    public const int m_vecTurningInaccuracyEyeDirLast = 0x16A8; // Vector
    public const int m_flTurningInaccuracy = 0x16B4; // float
    public const int m_fAccuracyPenalty = 0x16B8; // float
    public const int m_flLastAccuracyUpdateTime = 0x16BC; // GameTime_t
    public const int m_fAccuracySmoothedForZoom = 0x16C0; // float
    public const int m_fScopeZoomEndTime = 0x16C4; // GameTime_t
    public const int m_iRecoilIndex = 0x16C8; // int32_t
    public const int m_flRecoilIndex = 0x16CC; // float
    public const int m_bBurstMode = 0x16D0; // bool
    public const int m_nPostponeFireReadyTicks = 0x16D4; // GameTick_t
    public const int m_flPostponeFireReadyFrac = 0x16D8; // float
    public const int m_bInReload = 0x16DC; // bool
    public const int m_bReloadVisuallyComplete = 0x16DD; // bool
    public const int m_flDroppedAtTime = 0x16E0; // GameTime_t
    public const int m_bIsHauledBack = 0x16E4; // bool
    public const int m_bSilencerOn = 0x16E5; // bool
    public const int m_flTimeSilencerSwitchComplete = 0x16E8; // GameTime_t
    public const int m_iOriginalTeamNumber = 0x16EC; // int32_t
    public const int m_flNextAttackRenderTimeOffset = 0x16F0; // float
    public const int m_bVisualsDataSet = 0x1778; // bool
    public const int m_bOldFirstPersonSpectatedState = 0x1779; // bool
    public const int m_hOurPing = 0x177C; // CHandle<C_BaseEntity>
    public const int m_nOurPingIndex = 0x1780; // CEntityIndex
    public const int m_vecOurPingPos = 0x1784; // Vector
    public const int m_bGlowForPing = 0x1790; // bool
    public const int m_bUIWeapon = 0x1791; // bool
    public const int m_hPrevOwner = 0x17A0; // CHandle<C_CSPlayerPawn>
    public const int m_nDropTick = 0x17A4; // GameTick_t
    public const int m_donated = 0x17C4; // bool
    public const int m_fLastShotTime = 0x17C8; // GameTime_t
    public const int m_bWasOwnedByCT = 0x17CC; // bool
    public const int m_bWasOwnedByTerrorist = 0x17CD; // bool
    public const int m_gunHeat = 0x17D0; // float
    public const int m_smokeAttachments = 0x17D4; // uint32_t
    public const int m_lastSmokeTime = 0x17D8; // GameTime_t
    public const int m_flNextClientFireBulletTime = 0x17DC; // float
    public const int m_flNextClientFireBulletTime_Repredict = 0x17E0; // float
...
{
    // C_CSWeaponBase
    public const int m_zoomLevel = 0x1A00; // int32_t
    public const int m_iBurstShotsRemaining = 0x1A04; // int32_t
    public const int m_iSilencerBodygroup = 0x1A08; // int32_t
    public const int m_silencedModelIndex = 0x1A18; // int32_t
    public const int m_inPrecache = 0x1A1C; // bool
    public const int m_bNeedsBoltAction = 0x1A1D; // bool
}
...
{
    // C_CSWeaponBase
    public const int m_bPlayingUinterruptableAct = 0x1A00; // bool
    public const int m_nUinterruptableActivity = 0x1A04; // PlayerAnimEvent_t
}
...
{
    // C_CSWeaponBase
    public const int m_SequenceCompleteTimer = 0x1A00; // CountdownTimer
    public const int m_bRedraw = 0x1A18; // bool
}
...
{
    // C_CSWeaponBaseGun
    public const int m_flDisplayHealth = 0x1A20; // float
}

public static class C_WeaponTaser
{
    // C_CSWeaponBaseGun
    public const int m_fFireTime = 0x1A20; // GameTime_t
}
