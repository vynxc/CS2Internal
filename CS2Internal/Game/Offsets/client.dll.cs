...
{
    // C_CSWeaponBase
    public const int m_bClientPredictDelete = 0x1A10; // bool
    public const int m_bRedraw = 0x1A11; // bool
    public const int m_bIsHeldByPlayer = 0x1A12; // bool
    public const int m_bPinPulled = 0x1A13; // bool
    public const int m_bJumpThrow = 0x1A14; // bool
    public const int m_bThrowAnimating = 0x1A15; // bool
    public const int m_fThrowTime = 0x1A18; // GameTime_t
    public const int m_flThrowStrength = 0x1A1C; // float
    public const int m_flThrowStrengthApproach = 0x1A20; // float
    public const int m_fDropTime = 0x1A24; // GameTime_t
    public const int m_bJustPulledPin = 0x1A28; // bool
    public const int m_nNextHoldTick = 0x1A2C; // GameTick_t
    public const int m_flNextHoldFrac = 0x1A30; // float
    public const int m_hSwitchToWeaponAfterThrow = 0x1A34; // CHandle<C_CSWeaponBase>
}
...
{
    // C_CSWeaponBase
    public const int m_szScreenText = 0x1A10; // char[32]
    public const int m_activeLightParticleIndex = 0x1A30; // ParticleIndex_t
    public const int m_eActiveLightEffect = 0x1A34; // C4LightEffect_t
    public const int m_bStartedArming = 0x1A38; // bool
    public const int m_fArmedTime = 0x1A3C; // GameTime_t
    public const int m_bBombPlacedAnimation = 0x1A40; // bool
    public const int m_bIsPlantingViaUse = 0x1A41; // bool
    public const int m_entitySpottedState = 0x1A48; // EntitySpottedState_t
    public const int m_nSpotRules = 0x1A60; // int32_t
    public const int m_bPlayedArmingBeeps = 0x1A64; // bool[7]
    public const int m_bBombPlanted = 0x1A6B; // bool
    public const int m_bDroppedFromDeath = 0x1A6C; // bool
}
...
{
    // C_CSPlayerPawn
    public const int m_animgraph = 0x23B8; // CUtlString
    public const int m_animgraphCharacterModeString = 0x23C0; // CUtlString
    public const int m_flInitialModelScale = 0x23C8; // float
}
...
{
    // C_CSPlayerPawnBase
    public const int m_hDetectParentChange = 0x16B8; // CEntityHandle
}

public static class C_CSPlayerPawn
{
    // C_CSPlayerPawnBase
    public const int m_pBulletServices = 0x16B8; // CCSPlayer_BulletServices*
    public const int m_pHostageServices = 0x16C0; // CCSPlayer_HostageServices*
    public const int m_pBuyServices = 0x16C8; // CCSPlayer_BuyServices*
    public const int m_pGlowServices = 0x16D0; // CCSPlayer_GlowServices*
    public const int m_pActionTrackingServices = 0x16D8; // CCSPlayer_ActionTrackingServices*
    public const int m_flHealthShotBoostExpirationTime = 0x16E0; // GameTime_t
    public const int m_flLastFiredWeaponTime = 0x16E4; // GameTime_t
    public const int m_bHasFemaleVoice = 0x16E8; // bool
    public const int m_flLandseconds = 0x16EC; // float
    public const int m_flOldFallVelocity = 0x16F0; // float
    public const int m_szLastPlaceName = 0x16F4; // char[18]
    public const int m_bPrevDefuser = 0x1706; // bool
    public const int m_bPrevHelmet = 0x1707; // bool
    public const int m_nPrevArmorVal = 0x1708; // int32_t
    public const int m_nPrevGrenadeAmmoCount = 0x170C; // int32_t
    public const int m_unPreviousWeaponHash = 0x1710; // uint32_t
    public const int m_unWeaponHash = 0x1714; // uint32_t
    public const int m_bInBuyZone = 0x1718; // bool
    public const int m_bPreviouslyInBuyZone = 0x1719; // bool
    public const int m_aimPunchAngle = 0x171C; // QAngle
    public const int m_aimPunchAngleVel = 0x1728; // QAngle
    public const int m_aimPunchTickBase = 0x1734; // int32_t
    public const int m_aimPunchTickFraction = 0x1738; // float
    public const int m_aimPunchCache = 0x1740; // CUtlVector<QAngle>
    public const int m_bInLanding = 0x1760; // bool
    public const int m_flLandingTime = 0x1764; // float
    public const int m_bInHostageRescueZone = 0x1768; // bool
    public const int m_bInBombZone = 0x1769; // bool
    public const int m_bIsBuyMenuOpen = 0x176A; // bool
    public const int m_flTimeOfLastInjury = 0x176C; // GameTime_t
    public const int m_flNextSprayDecalTime = 0x1770; // GameTime_t
    public const int m_iRetakesOffering = 0x1888; // int32_t
    public const int m_iRetakesOfferingCard = 0x188C; // int32_t
    public const int m_bRetakesHasDefuseKit = 0x1890; // bool
    public const int m_bRetakesMVPLastRound = 0x1891; // bool
    public const int m_iRetakesMVPBoostItem = 0x1894; // int32_t
    public const int m_RetakesMVPBoostExtraUtility = 0x1898; // loadout_slot_t
    public const int m_bNeedToReApplyGloves = 0x18B8; // bool
    public const int m_EconGloves = 0x18C0; // C_EconItemView
    public const int m_bMustSyncRagdollState = 0x1D08; // bool
    public const int m_nRagdollDamageBone = 0x1D0C; // int32_t
    public const int m_vRagdollDamageForce = 0x1D10; // Vector
    public const int m_vRagdollDamagePosition = 0x1D1C; // Vector
    public const int m_szRagdollDamageWeaponName = 0x1D28; // char[64]
    public const int m_bRagdollDamageHeadshot = 0x1D68; // bool
    public const int m_vRagdollServerOrigin = 0x1D6C; // Vector
    public const int m_bLastHeadBoneTransformIsValid = 0x2380; // bool
    public const int m_lastLandTime = 0x2384; // GameTime_t
    public const int m_bOnGroundLastTick = 0x2388; // bool
    public const int m_qDeathEyeAngles = 0x23A4; // QAngle
    public const int m_bSkipOneHeadConstraintUpdate = 0x23B0; // bool
}
...
public static class C_CSPlayerPawnBase
{
    ...
    public const int m_fRenderingClipPlane = 0x1280; // float[4]
    public const int m_nLastClipPlaneSetupFrame = 0x1290; // int32_t
    public const int m_vecLastClipCameraPos = 0x1294; // Vector
    public const int m_vecLastClipCameraForward = 0x12A0; // Vector
    public const int m_bClipHitStaticWorld = 0x12AC; // bool
    public const int m_bCachedPlaneIsValid = 0x12AD; // bool
    public const int m_pClippingWeapon = 0x12B0; // C_CSWeaponBase*
    public const int m_previousPlayerState = 0x12B8; // CSPlayerState
    public const int m_flLastCollisionCeiling = 0x12BC; // float
    public const int m_flLastCollisionCeilingChangeTime = 0x12C0; // float
    public const int m_grenadeParameterStashTime = 0x12E0; // GameTime_t
    public const int m_bGrenadeParametersStashed = 0x12E4; // bool
    public const int m_angStashedShootAngles = 0x12E8; // QAngle
    public const int m_vecStashedGrenadeThrowPosition = 0x12F4; // Vector
    public const int m_vecStashedVelocity = 0x1300; // Vector
    public const int m_angShootAngleHistory = 0x130C; // QAngle[2]
    public const int m_vecThrowPositionHistory = 0x1324; // Vector[2]
    public const int m_vecVelocityHistory = 0x133C; // Vector[2]
    public const int m_thirdPersonHeading = 0x1358; // QAngle
    public const int m_flSlopeDropOffset = 0x1370; // float
    public const int m_flSlopeDropHeight = 0x1380; // float
    public const int m_vHeadConstraintOffset = 0x1390; // Vector
    public const int m_bIsScoped = 0x13A8; // bool
    public const int m_bIsWalking = 0x13A9; // bool
    public const int m_bResumeZoom = 0x13AA; // bool
    public const int m_iPlayerState = 0x13AC; // CSPlayerState
    public const int m_bIsDefusing = 0x13B0; // bool
    public const int m_bIsGrabbingHostage = 0x13B1; // bool
    public const int m_iBlockingUseActionInProgress = 0x13B4; // CSPlayerBlockingUseAction_t
    public const int m_bIsRescuing = 0x13B8; // bool
    public const int m_fImmuneToGunGameDamageTime = 0x13BC; // GameTime_t
    public const int m_fImmuneToGunGameDamageTimeLast = 0x13C0; // GameTime_t
    public const int m_bGunGameImmunity = 0x13C4; // bool
    public const int m_bHasMovedSinceSpawn = 0x13C5; // bool
    public const int m_fMolotovUseTime = 0x13C8; // float
    public const int m_fMolotovDamageTime = 0x13CC; // float
    public const int m_nWhichBombZone = 0x13D0; // int32_t
    public const int m_bInNoDefuseArea = 0x13D4; // bool
    public const int m_iThrowGrenadeCounter = 0x13D8; // int32_t
    public const int m_bWaitForNoAttack = 0x13DC; // bool
    public const int m_flGuardianTooFarDistFrac = 0x13E0; // float
    public const int m_flDetectedByEnemySensorTime = 0x13E4; // GameTime_t
    public const int m_flNextGuardianTooFarWarning = 0x13E8; // float
    public const int m_bSuppressGuardianTooFarWarningAudio = 0x13EC; // bool
    public const int m_bKilledByTaser = 0x13ED; // bool
    public const int m_iMoveState = 0x13F0; // int32_t
    public const int m_bCanMoveDuringFreezePeriod = 0x13F4; // bool
    public const int m_flLowerBodyYawTarget = 0x13F8; // float
    public const int m_bStrafing = 0x13FC; // bool
    public const int m_flLastSpawnTimeIndex = 0x1400; // GameTime_t
    public const int m_flEmitSoundTime = 0x1404; // GameTime_t
    public const int m_iAddonBits = 0x1408; // int32_t
    public const int m_iPrimaryAddon = 0x140C; // int32_t
    public const int m_iSecondaryAddon = 0x1410; // int32_t
    public const int m_iProgressBarDuration = 0x1414; // int32_t
    public const int m_flProgressBarStartTime = 0x1418; // float
    public const int m_iDirection = 0x141C; // int32_t
    public const int m_iShotsFired = 0x1420; // int32_t
    public const int m_bNightVisionOn = 0x1424; // bool
    public const int m_bHasNightVision = 0x1425; // bool
    public const int m_flVelocityModifier = 0x1428; // float
    public const int m_flHitHeading = 0x142C; // float
    public const int m_nHitBodyPart = 0x1430; // int32_t
    public const int m_iStartAccount = 0x1434; // int32_t
    public const int m_vecIntroStartEyePosition = 0x1438; // Vector
    public const int m_vecIntroStartPlayerForward = 0x1444; // Vector
    public const int m_flClientDeathTime = 0x1450; // GameTime_t
    public const int m_flNightVisionAlpha = 0x1454; // float
    public const int m_bScreenTearFrameCaptured = 0x1458; // bool
    public const int m_flFlashBangTime = 0x145C; // float
    public const int m_flFlashScreenshotAlpha = 0x1460; // float
    public const int m_flFlashOverlayAlpha = 0x1464; // float
    public const int m_bFlashBuildUp = 0x1468; // bool
    public const int m_bFlashDspHasBeenCleared = 0x1469; // bool
    public const int m_bFlashScreenshotHasBeenGrabbed = 0x146A; // bool
    public const int m_flFlashMaxAlpha = 0x146C; // float
    public const int m_flFlashDuration = 0x1470; // float
    public const int m_lastStandingPos = 0x1474; // Vector
    public const int m_vecLastMuzzleFlashPos = 0x1480; // Vector
    public const int m_angLastMuzzleFlashAngle = 0x148C; // QAngle
    public const int m_hMuzzleFlashShape = 0x1498; // CHandle<C_BaseEntity>
    public const int m_iHealthBarRenderMaskIndex = 0x149C; // int32_t
    public const int m_flHealthFadeValue = 0x14A0; // float
    public const int m_flHealthFadeAlpha = 0x14A4; // float
    public const int m_nMyCollisionGroup = 0x14A8; // int32_t
    public const int m_ignoreLadderJumpTime = 0x14AC; // float
    public const int m_ladderSurpressionTimer = 0x14B0; // CountdownTimer
    public const int m_lastLadderNormal = 0x14C8; // Vector
    public const int m_lastLadderPos = 0x14D4; // Vector
    public const int m_flDeathCCWeight = 0x14E8; // float
    public const int m_bOldIsScoped = 0x14EC; // bool
    public const int m_flPrevRoundEndTime = 0x14F0; // float
    public const int m_flPrevMatchEndTime = 0x14F4; // float
    public const int m_unCurrentEquipmentValue = 0x14F8; // uint16_t
    public const int m_unRoundStartEquipmentValue = 0x14FA; // uint16_t
    public const int m_unFreezetimeEndEquipmentValue = 0x14FC; // uint16_t
    public const int m_vecThirdPersonViewPositionOverride = 0x1500; // Vector
    public const int m_nHeavyAssaultSuitCooldownRemaining = 0x150C; // int32_t
    public const int m_ArmorValue = 0x1510; // int32_t
    public const int m_angEyeAngles = 0x1518; // QAngle
    public const int m_fNextThinkPushAway = 0x1530; // float
    public const int m_bShouldAutobuyDMWeapons = 0x1534; // bool
    public const int m_bShouldAutobuyNow = 0x1535; // bool
    public const int m_bHud_MiniScoreHidden = 0x1536; // bool
    public const int m_bHud_RadarHidden = 0x1537; // bool
    public const int m_nLastKillerIndex = 0x1538; // CEntityIndex
    public const int m_nLastConcurrentKilled = 0x153C; // int32_t
    public const int m_nDeathCamMusic = 0x1540; // int32_t
    public const int m_iIDEntIndex = 0x1544; // CEntityIndex
    public const int m_delayTargetIDTimer = 0x1548; // CountdownTimer
    public const int m_iTargetedWeaponEntIndex = 0x1560; // CEntityIndex
    public const int m_iOldIDEntIndex = 0x1564; // CEntityIndex
    public const int m_holdTargetIDTimer = 0x1568; // CountdownTimer
    public const int m_flCurrentMusicStartTime = 0x1584; // float
    public const int m_flMusicRoundStartTime = 0x1588; // float
    public const int m_bDeferStartMusicOnWarmup = 0x158C; // bool
    public const int m_cycleLatch = 0x1590; // int32_t
    public const int m_serverIntendedCycle = 0x1594; // float
    public const int m_vecPlayerPatchEconIndices = 0x1598; // uint32_t[5]
    public const int m_bHideTargetID = 0x15B4; // bool
    public const int m_nextTaserShakeTime = 0x15B8; // float
    public const int m_firstTaserShakeTime = 0x15BC; // float
    public const int m_flLastSmokeOverlayAlpha = 0x15C0; // float
    public const int m_vLastSmokeOverlayColor = 0x15C4; // Vector
    public const int m_nPlayerSmokedFx = 0x15D0; // ParticleIndex_t
    public const int m_flNextMagDropTime = 0x15D4; // float
    public const int m_nLastMagDropAttachmentIndex = 0x15D8; // int32_t
    public const int m_vecBulletHitModels = 0x15E0; // CUtlVector<C_BulletHitModel*>
    public const int m_vecPickupModelSlerpers = 0x15F8; // CUtlVector<C_PickUpModelSlerper*>
    public const int m_vecLastAliveLocalVelocity = 0x1610; // Vector
    public const int m_entitySpottedState = 0x1638; // EntitySpottedState_t
    public const int m_nSurvivalTeamNumber = 0x1650; // int32_t
    public const int m_bGuardianShouldSprayCustomXMark = 0x1654; // bool
    public const int m_bHasDeathInfo = 0x1655; // bool
    public const int m_flDeathInfoTime = 0x1658; // float
    public const int m_vecDeathInfoOrigin = 0x165C; // Vector
    public const int m_bKilledByHeadshot = 0x1668; // bool
    public const int m_hOriginalController = 0x166C; // CHandle<CCSPlayerController>
}
...
public static class C_CSWeaponBase
{
    ...
    public const int m_ePlayerFireEvent = 0x15E0; // PlayerAnimEvent_t
    public const int m_ePlayerFireEventAttackType = 0x15E4; // WeaponAttackType_t
    public const int m_seqIdle = 0x15E8; // HSequence
    public const int m_seqFirePrimary = 0x15EC; // HSequence
    public const int m_seqFireSecondary = 0x15F0; // HSequence
    public const int m_thirdPersonFireSequences = 0x15F8; // CUtlVector<HSequence>
    public const int m_hCurrentThirdPersonSequence = 0x1610; // HSequence
    public const int m_nSilencerBoneIndex = 0x1614; // int32_t
    public const int m_thirdPersonSequences = 0x1618; // HSequence[7]
    public const int m_ClientPreviousWeaponState = 0x1650; // CSWeaponState_t
    public const int m_iState = 0x1654; // CSWeaponState_t
    public const int m_flCrosshairDistance = 0x1658; // float
    public const int m_iAmmoLastCheck = 0x165C; // int32_t
    public const int m_iAlpha = 0x1660; // int32_t
    public const int m_iScopeTextureID = 0x1664; // int32_t
    public const int m_iCrosshairTextureID = 0x1668; // int32_t
    public const int m_flGunAccuracyPosition = 0x166C; // float
    public const int m_nViewModelIndex = 0x1670; // uint32_t
    public const int m_bReloadsWithClips = 0x1674; // bool
    public const int m_flTimeWeaponIdle = 0x1678; // GameTime_t
    public const int m_bFireOnEmpty = 0x167C; // bool
    public const int m_OnPlayerPickup = 0x1680; // CEntityIOOutput
    public const int m_weaponMode = 0x16A8; // CSWeaponMode
    public const int m_flTurningInaccuracyDelta = 0x16AC; // float
    public const int m_vecTurningInaccuracyEyeDirLast = 0x16B0; // Vector
    public const int m_flTurningInaccuracy = 0x16BC; // float
    public const int m_fAccuracyPenalty = 0x16C0; // float
    public const int m_flLastAccuracyUpdateTime = 0x16C4; // GameTime_t
    public const int m_fAccuracySmoothedForZoom = 0x16C8; // float
    public const int m_fScopeZoomEndTime = 0x16CC; // GameTime_t
    public const int m_iRecoilIndex = 0x16D0; // int32_t
    public const int m_flRecoilIndex = 0x16D4; // float
    public const int m_bBurstMode = 0x16D8; // bool
    public const int m_nPostponeFireReadyTicks = 0x16DC; // GameTick_t
    public const int m_flPostponeFireReadyFrac = 0x16E0; // float
    public const int m_bInReload = 0x16E4; // bool
    public const int m_bReloadVisuallyComplete = 0x16E5; // bool
    public const int m_flDroppedAtTime = 0x16E8; // GameTime_t
    public const int m_bIsHauledBack = 0x16EC; // bool
    public const int m_bSilencerOn = 0x16ED; // bool
    public const int m_flTimeSilencerSwitchComplete = 0x16F0; // GameTime_t
    public const int m_iOriginalTeamNumber = 0x16F4; // int32_t
    public const int m_flNextAttackRenderTimeOffset = 0x16F8; // float
    public const int m_bVisualsDataSet = 0x1780; // bool
    public const int m_bOldFirstPersonSpectatedState = 0x1781; // bool
    public const int m_hOurPing = 0x1784; // CHandle<C_BaseEntity>
    public const int m_nOurPingIndex = 0x1788; // CEntityIndex
    public const int m_vecOurPingPos = 0x178C; // Vector
    public const int m_bGlowForPing = 0x1798; // bool
    public const int m_bUIWeapon = 0x1799; // bool
    public const int m_hPrevOwner = 0x17A8; // CHandle<C_CSPlayerPawn>
    public const int m_nDropTick = 0x17AC; // GameTick_t
    public const int m_donated = 0x17CC; // bool
    public const int m_fLastShotTime = 0x17D0; // GameTime_t
    public const int m_bWasOwnedByCT = 0x17D4; // bool
    public const int m_bWasOwnedByTerrorist = 0x17D5; // bool
    public const int m_gunHeat = 0x17D8; // float
    public const int m_smokeAttachments = 0x17DC; // uint32_t
    public const int m_lastSmokeTime = 0x17E0; // GameTime_t
    public const int m_flNextClientFireBulletTime = 0x17E4; // float
    public const int m_flNextClientFireBulletTime_Repredict = 0x17E8; // float
    public const int m_IronSightController = 0x18C0; // C_IronSightController
    public const int m_iIronSightMode = 0x1970; // int32_t
    public const int m_flLastLOSTraceFailureTime = 0x1980; // GameTime_t
    public const int m_iNumEmptyAttacks = 0x1984; // int32_t
    public const int m_flLastMagDropRequestTime = 0x1A00; // GameTime_t
}

public static class C_CSWeaponBaseGun
{
    // C_CSWeaponBase
    public const int m_zoomLevel = 0x1A10; // int32_t
    public const int m_iBurstShotsRemaining = 0x1A14; // int32_t
    public const int m_iSilencerBodygroup = 0x1A18; // int32_t
    public const int m_silencedModelIndex = 0x1A28; // int32_t
    public const int m_inPrecache = 0x1A2C; // bool
    public const int m_bNeedsBoltAction = 0x1A2D; // bool
}
...
{
    // C_CSWeaponBase
    public const int m_bPlayingUinterruptableAct = 0x1A10; // bool
    public const int m_nUinterruptableActivity = 0x1A14; // PlayerAnimEvent_t
}
...
{
    // C_CSWeaponBase
    public const int m_SequenceCompleteTimer = 0x1A10; // CountdownTimer
    public const int m_bRedraw = 0x1A28; // bool
}
...
{
    // C_CSWeaponBaseGun
    public const int m_flDisplayHealth = 0x1A30; // float
}

public static class C_WeaponTaser
{
    // C_CSWeaponBaseGun
    public const int m_fFireTime = 0x1A30; // GameTime_t
}
