...
public static class client_dll
{
    ...
    public const nint dwForceAttack = 0x16B5400;
    public const nint dwForceAttack2 = 0x16B5490;
    public const nint dwForceBackward = 0x16B56D0;
    public const nint dwForceCrouch = 0x16B59A0;
    public const nint dwForceForward = 0x16B5640;
    public const nint dwForceJump = 0x16B5910;
    public const nint dwForceLeft = 0x16B5760;
    public const nint dwForceRight = 0x16B57F0;
    public const nint dwGameEntitySystem = 0x18DC3D0;
    public const nint dwGameEntitySystem_getHighestEntityIndex = 0x1510;
    public const nint dwGameRules = 0x180C9A0;
    public const nint dwGlobalVars = 0x16B14E0;
    ...
    public const nint dwLocalPlayerPawn = 0x16BC4A8;
    public const nint dwPlantedC4 = 0x1813F68;
    public const nint dwPrediction = 0x16BC370;
    public const nint dwSensitivity = 0x180DF58;
    public const nint dwSensitivity_sensitivity = 0x40;
    public const nint dwViewAngles = 0x186FFB0;
